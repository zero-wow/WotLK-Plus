...
function Palette:CreateRow(index)
  ...
  Theme:ApplyBackdrop(row, Theme.colors.surface, { Theme.colors.border[1], Theme.colors.border[2], Theme.colors.border[3], 0.25 })

  row.IconShell = CreateFrame("Frame", nil, row)
  row.IconShell:SetPoint("LEFT", row, "LEFT", 5, 0)
  row.IconShell:SetWidth(19)
  row.IconShell:SetHeight(19)
  Theme:ApplyBackdrop(row.IconShell, Theme.colors.inset, { Theme.colors.border[1], Theme.colors.border[2], Theme.colors.border[3], 0.30 })
  ...
  row.Label:SetPoint("LEFT", row.IconShell, "RIGHT", 8, 0)
  ...
  row:SetScript("OnLeave", function(button)
    setBorder(button, { Theme.colors.border[1], Theme.colors.border[2], Theme.colors.border[3], 0.25 })
    GameTooltip:Hide()
  end)
